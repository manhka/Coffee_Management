...
// Tự động scroll đến ô input đang focus khi bàn phím mở
        ...
        selectedPendingOrderItem = orderItemRepo.getAllSelectedOrderItemsByStatusAndUserId(OrderItemStatus.PENDING.getValue(),MySharePrefers.getUserId());
        ...
        binding.btnPayOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                order.setOrderStatus(OrderStatus.PAY.getValue());
